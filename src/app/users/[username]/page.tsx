        ...
        <div>
            <Breadcrumb>
                <BreadcrumbList>
                    ...
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                        <BreadcrumbPage>James Bond</BreadcrumbPage>
                    </BreadcrumbItem>
                </BreadcrumbList>
            </Breadcrumb>
            {/* CONTAINER */}
                    ...
                    <div className="bg-primary-foreground p-4 rounded-lg">
                        ...
                        <div className="flex gap-4 mt-4">
                            <HoverCard>
                                ...
                                <HoverCardContent>
                                    <h1 className="font-bont mb-2">Verified User</h1>
                    ...
                    <div className="bg-primary-foreground p-4 rounded-lg">
                        ...
                        <div className="space-y-4 mt-4">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span>jamesbond@hotmale.com</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="font-bold">
                                    Phone:
                                </span>
                                <span>+91 98765 43120</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="font-bold">
                                    Location:
                            ...
                            <p className="text-sm text-muted-foreground mt-4">Joined on 27th July, 2024</p>
                        </div>
                    </div>
                    {/* CARD LIST */}
                    <div className="bg-primary-foreground p-4 rounded-lg">
                ...
                <div className="w-full xl:w-2/3 space-y-6">
                    ...
                    <div className="bg-primary-foreground p-4 rounded-lg">
                        <div className="flex items-center gap-2">
                            ...
                            <h1 className="text-xl font-semibold">James Bold</h1>
                        </div>
                        <p className="text-sm text-muted-foreground">
